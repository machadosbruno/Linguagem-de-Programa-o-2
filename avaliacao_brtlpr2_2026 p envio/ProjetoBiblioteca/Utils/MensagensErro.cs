...
namespace ProjetoBiblioteca.Utils
{
    namespace MensagensErro
    {
        internal static class Livro
        {
            ...
            internal static string Autor_Invalido = "Escolha um autor";
        }

        internal static class Autor
        {
            internal static string Item_Invalido = "O autor informado é inválido";
            internal static string Nome_Obrigatorio = "O nome do autor é obrigatório";
            internal static string Email_Obrigatorio = "O email do autor é obrigatório";
            internal static string Email_Ja_Cadastrado = "O email informado já está cadastrado no sistema";
            internal static string DataNascimento_Obrigatorio = "A data de nascimento do autor é obrigatória";
            internal static string DataNascimento_Maximo = "A data de nascimento não pode ser uma data futura";
